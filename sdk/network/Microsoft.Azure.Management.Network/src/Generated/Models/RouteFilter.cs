...
namespace Microsoft.Azure.Management.Network.Models
{
    ...
    public partial class RouteFilter : Resource
    {
        ...
        public RouteFilter(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IList<RouteFilterRule> rules = default(IList<RouteFilterRule>), IList<SubResource> peerings = default(IList<SubResource>), IList<SubResource> ipv6Peerings = default(IList<SubResource>), string provisioningState = default(string), string etag = default(string))
        ...
        public IList<SubResource> Ipv6Peerings { get; private set; }
