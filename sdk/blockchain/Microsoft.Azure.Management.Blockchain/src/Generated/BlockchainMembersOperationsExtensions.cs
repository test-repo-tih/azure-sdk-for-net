...
namespace Microsoft.Azure.Management.Blockchain
{
    ...
    public static partial class BlockchainMembersOperationsExtensions
    {
            ...
            /// </param>
            public static ApiKeyCollection RegenerateApiKeys(this IBlockchainMembersOperations operations, string blockchainMemberName, string resourceGroupName, string keyName = default(string), string value = default(string))
            {
                return operations.RegenerateApiKeysAsync(blockchainMemberName, resourceGroupName, keyName, value).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ApiKeyCollection> RegenerateApiKeysAsync(this IBlockchainMembersOperations operations, string blockchainMemberName, string resourceGroupName, string keyName = default(string), string value = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RegenerateApiKeysWithHttpMessagesAsync(blockchainMemberName, resourceGroupName, keyName, value, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
