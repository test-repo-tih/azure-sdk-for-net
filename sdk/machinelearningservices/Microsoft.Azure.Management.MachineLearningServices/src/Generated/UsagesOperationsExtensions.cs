...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class UsagesOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<Usage> List(this IUsagesOperations operations, string location, string expandChildren = default(string))
            {
                return operations.ListAsync(location, expandChildren).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<IPage<Usage>> ListAsync(this IUsagesOperations operations, string location, string expandChildren = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ListWithHttpMessagesAsync(location, expandChildren, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
