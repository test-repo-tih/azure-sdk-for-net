...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class UserAccountCredentials
    {
        ...
        public UserAccountCredentials(string adminUserName, string adminUserSshPublicKey = default(string), string adminUserPassword = default(string))
        {
        ...
        /// </summary>
        /// <remarks>
        /// SSH public key of the administrator user account. This property is
        /// only supported on Linux based clusters.
        /// </remarks>
