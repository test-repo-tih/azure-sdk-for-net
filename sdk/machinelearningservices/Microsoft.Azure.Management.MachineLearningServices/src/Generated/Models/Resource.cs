...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class Resource : IResource
    {
        ...
        /// pairs.</param>
        public Resource(string id = default(string), string name = default(string), Identity identity = default(Identity), string location = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Id = id;
            Name = name;
            Identity = identity;
