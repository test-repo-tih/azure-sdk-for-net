...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class Workspace : Resource
    {
        ...
        /// 'Canceled'</param>
        public Workspace(string id = default(string), string name = default(string), Identity identity = default(Identity), string location = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string workspaceId = default(string), string description = default(string), string friendlyName = default(string), System.DateTime? creationTime = default(System.DateTime?), string keyVault = default(string), string applicationInsights = default(string), string containerRegistry = default(string), string storageAccount = default(string), string discoveryUrl = default(string), string provisioningState = default(string))
