...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    internal partial class UsagesOperations : IServiceOperations<AzureMachineLearningWorkspacesClient>, IUsagesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<Usage>>> ListWithHttpMessagesAsync(string location, string expandChildren = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("expandChildren", expandChildren);
            ...
            {
                _queryParameters.Add(string.Format("expandChildren={0}", System.Uri.EscapeDataString(expandChildren)));
            }
