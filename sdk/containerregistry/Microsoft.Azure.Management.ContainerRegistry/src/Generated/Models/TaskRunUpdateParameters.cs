...
namespace Microsoft.Azure.Management.ContainerRegistry.Models
{
    ...
    public partial class TaskRunUpdateParameters
    {
        ...
        public TaskRunUpdateParameters(IdentityProperties identity = default(IdentityProperties), RunRequest runRequest = default(RunRequest), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Identity = identity;
