...
namespace Microsoft.Azure.Management.VMwareCloudSimple.Models
{
    ...
    public partial class VirtualNic
    {
        ...
        public VirtualNic(VirtualNetwork network, NICType nicType, IList<string> ipAddresses = default(IList<string>), string macAddress = default(string), bool? powerOnBoot = default(bool?), string virtualNicId = default(string), string virtualNicName = default(string))
        {
