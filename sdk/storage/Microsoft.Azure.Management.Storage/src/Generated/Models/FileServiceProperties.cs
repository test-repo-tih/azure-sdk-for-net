...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class FileServiceProperties : Resource
    {
        ...
        public FileServiceProperties(string id = default(string), string name = default(string), string type = default(string), CorsRules cors = default(CorsRules), DeleteRetentionPolicy shareDeleteRetentionPolicy = default(DeleteRetentionPolicy))
            : base(id, name, type)
        {
            Cors = cors;
