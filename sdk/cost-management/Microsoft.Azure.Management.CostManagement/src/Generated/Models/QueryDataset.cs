...
namespace Microsoft.Azure.Management.CostManagement.Models
{
    ...
    public partial class QueryDataset
    {
        ...
        /// Possible values include: 'Daily', 'Hourly'</param>
        ...
        /// <param name="sorting">Array of sorting by columns in query.</param>
        /// <param name="filter">Has filter expression to use in the
        /// query.</param>
        public QueryDataset(string granularity = default(string), QueryDatasetConfiguration configuration = default(QueryDatasetConfiguration), IDictionary<string, QueryAggregation> aggregation = default(IDictionary<string, QueryAggregation>), IList<QueryGrouping> grouping = default(IList<QueryGrouping>), IList<QuerySortingConfiguration> sorting = default(IList<QuerySortingConfiguration>), QueryFilter filter = default(QueryFilter))
        {
        ...
        /// <summary>
        /// Gets or sets array of sorting by columns in query.
        /// </summary>
        [JsonProperty(PropertyName = "sorting")]
        public IList<QuerySortingConfiguration> Sorting { get; set; }
