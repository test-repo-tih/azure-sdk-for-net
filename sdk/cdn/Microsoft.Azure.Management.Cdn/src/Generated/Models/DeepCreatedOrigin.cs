...
namespace Microsoft.Azure.Management.Cdn.Models
{
    ...
    public partial class DeepCreatedOrigin : IResource
    {
        ...
        /// <param name="enabled">Origin is enabled for load balancing or not.
        /// By default, origin is always enabled.</param>
        public DeepCreatedOrigin(string name, string hostName, int? httpPort = default(int?), int? httpsPort = default(int?), string originHostHeader = default(string), int? priority = default(int?), int? weight = default(int?), bool? enabled = default(bool?))
        {
            Name = name;
            HostName = hostName;
            HttpPort = httpPort;
