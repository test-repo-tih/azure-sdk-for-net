...
namespace Microsoft.Azure.Management.Security.Models
{
    ...
    public partial class Automation : TrackedResource
    {
        ...
        /// is enabled.</param>
        /// <param name="metadata">The metadata of the security automation
        /// resource.</param>
        ...
        /// one ruleset, are true.</param>
        public Automation(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string kind = default(string), string etag = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string description = default(string), bool? isEnabled = default(bool?), AutomationMetadata metadata = default(AutomationMetadata), IList<AutomationScope> scopes = default(IList<AutomationScope>), IList<AutomationSource> sources = default(IList<AutomationSource>), IList<AutomationAction> actions = default(IList<AutomationAction>))
        ...
        /// <summary>
        /// Gets or sets the metadata of the security automation resource.
        /// </summary>
        [JsonProperty(PropertyName = "properties.metadata")]
        public AutomationMetadata Metadata { get; set; }
        ...
        /// the configured rules evaluations, within at least one ruleset, are
        /// true.
        /// </summary>
