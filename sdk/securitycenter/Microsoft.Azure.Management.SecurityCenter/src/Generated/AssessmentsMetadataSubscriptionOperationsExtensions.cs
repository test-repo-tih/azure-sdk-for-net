...
namespace Microsoft.Azure.Management.Security
{
    ...
    public static partial class AssessmentsMetadataSubscriptionOperationsExtensions
    {
            ...
            /// The Assessment Key - Unique key for the assessment type
            /// </param>
            public static SecurityAssessmentMetadata Create(this IAssessmentsMetadataSubscriptionOperations operations, string assessmentMetadataName)
            {
                return operations.CreateAsync(assessmentMetadataName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SecurityAssessmentMetadata> CreateAsync(this IAssessmentsMetadataSubscriptionOperations operations, string assessmentMetadataName, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateWithHttpMessagesAsync(assessmentMetadataName, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
