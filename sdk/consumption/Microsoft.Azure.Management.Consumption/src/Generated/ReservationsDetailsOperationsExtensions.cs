...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    public static partial class ReservationsDetailsOperationsExtensions
    {
            ...
            /// start date and end date. The filter supports 'le' and  'ge'
            /// </param>
            public static IPage<ReservationDetail> List(this IReservationsDetailsOperations operations, string scope, string startDate = default(string), string endDate = default(string), string filter = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<ReservationDetail>> ListAsync(this IReservationsDetailsOperations operations, string scope, string startDate = default(string), string endDate = default(string), string filter = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
