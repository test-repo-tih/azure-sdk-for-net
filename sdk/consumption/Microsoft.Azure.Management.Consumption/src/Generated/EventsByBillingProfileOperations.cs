...
namespace Microsoft.Azure.Management.Consumption
{
    ...
    /// </summary>
    internal partial class EventsByBillingProfileOperations : IServiceOperations<ConsumptionManagementClient>, IEventsByBillingProfileOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<EventSummary>>> ListWithHttpMessagesAsync(string billingAccountId, string billingProfileId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.StartDate");
            }
            if (Client.EndDate == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.EndDate");
            }
            // Tracing
            ...
            if (Client.StartDate != null)
            {
                _queryParameters.Add(string.Format("startDate={0}", System.Uri.EscapeDataString(Client.StartDate)));
            }
            if (Client.EndDate != null)
            {
                _queryParameters.Add(string.Format("endDate={0}", System.Uri.EscapeDataString(Client.EndDate)));
            }
