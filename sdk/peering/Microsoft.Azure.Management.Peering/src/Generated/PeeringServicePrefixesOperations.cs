...
namespace Microsoft.Azure.Management.Peering
{
    ...
    /// </summary>
    internal partial class PeeringServicePrefixesOperations : IServiceOperations<PeeringManagementClient>, IPeeringServicePrefixesOperations
    {
        /// <summary>
        /// Initializes a new instance of the PeeringServicePrefixesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal PeeringServicePrefixesOperations(PeeringManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<PeeringServicePrefix>> GetWithHttpMessagesAsync(string resourceGroupName, string peeringServiceName, string prefixName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PeeringServicePrefix>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string peeringServiceName, string prefixName, PeeringServicePrefix peeringServicePrefix, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "peeringServicePrefix");
            }
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
