...
namespace Microsoft.Azure.Management.Peering
{
    ...
    internal partial class PrefixesOperations : IServiceOperations<PeeringManagementClient>, IPrefixesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<PeeringServicePrefix>>> ListByPeeringServiceWithHttpMessagesAsync(string resourceGroupName, string peeringServiceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
