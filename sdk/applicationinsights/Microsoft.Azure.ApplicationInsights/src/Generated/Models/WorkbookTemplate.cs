...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    public partial class WorkbookTemplate : WorkbookTemplateResource
    {
        /// <summary>
        /// Initializes a new instance of the WorkbookTemplate class.
        /// </summary>
        ...
        /// <param name="id">Id of the workbook template. This is GUID
        /// value.</param>
        ...
        /// portal.</param>
        public WorkbookTemplate(string location, string id, object templateData, IList<WorkbookTemplateGallery> galleries, string resourceId = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), int? priority = default(int?), string author = default(string), IDictionary<string, IList<WorkbookTemplateLocalizedGallery>> localized = default(IDictionary<string, IList<WorkbookTemplateLocalizedGallery>>))
            : base(location, resourceId, name, type, tags)
        {
            Id = id;
            Priority = priority;
            Author = author;
        ...
        /// <summary>
        /// Gets or sets id of the workbook template. This is GUID value.
        /// </summary>
