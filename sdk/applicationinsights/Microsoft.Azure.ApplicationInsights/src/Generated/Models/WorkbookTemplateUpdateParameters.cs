...
namespace Microsoft.Azure.Management.ApplicationInsights.Management.Models
{
    ...
    public partial class WorkbookTemplateUpdateParameters
    {
        ...
        /// portal.</param>
        public WorkbookTemplateUpdateParameters(string id, object templateData, IList<WorkbookTemplateGallery> galleries, IDictionary<string, string> tags = default(IDictionary<string, string>), int? priority = default(int?), string author = default(string), IDictionary<string, IList<WorkbookTemplateLocalizedGallery>> localized = default(IDictionary<string, IList<WorkbookTemplateLocalizedGallery>>))
        {
            Tags = tags;
            Id = id;
            Priority = priority;
