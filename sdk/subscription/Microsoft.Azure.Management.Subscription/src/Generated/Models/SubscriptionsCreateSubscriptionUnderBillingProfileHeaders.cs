...
namespace Microsoft.Azure.Management.Subscription.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateSubscriptionUnderBillingProfile operation.
    /// </summary>
    public partial class SubscriptionsCreateSubscriptionUnderBillingProfileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionsCreateSubscriptionUnderBillingProfileHeaders class.
        /// </summary>
        public SubscriptionsCreateSubscriptionUnderBillingProfileHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public SubscriptionsCreateSubscriptionUnderBillingProfileHeaders(string location = default(string), int? retryAfter = default(int?))
        {
            Location = location;
