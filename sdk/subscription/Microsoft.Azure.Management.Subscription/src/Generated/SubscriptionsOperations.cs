...
namespace Microsoft.Azure.Management.Subscription
{
    ...
    internal partial class SubscriptionsOperations : IServiceOperations<SubscriptionClient>, ISubscriptionsOperations
    {
        ...
        {
            // Send request
            AzureOperationResponse<SubscriptionCreationResult,SubscriptionsCreateSubscriptionHeaders> _response = await BeginCreateSubscriptionWithHttpMessagesAsync(billingAccountName, invoiceSectionName, body, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<SubscriptionCreationResult,SubscriptionsCreateSubscriptionUnderBillingProfileHeaders>> CreateSubscriptionUnderBillingProfileWithHttpMessagesAsync(string billingAccountName, string billingProfileName, string invoiceSectionName, ModernSubscriptionCreationParameters body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<SubscriptionCreationResult,SubscriptionsCreateSubscriptionUnderBillingProfileHeaders> _response = await BeginCreateSubscriptionUnderBillingProfileWithHttpMessagesAsync(billingAccountName, billingProfileName, invoiceSectionName, body, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async Task<AzureOperationResponse<SubscriptionCreationResult,SubscriptionsCreateSubscriptionUnderBillingProfileHeaders>> BeginCreateSubscriptionUnderBillingProfileWithHttpMessagesAsync(string billingAccountName, string billingProfileName, string invoiceSectionName, ModernSubscriptionCreationParameters body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("body", body);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginCreateSubscriptionUnderBillingProfile", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            ...
            // Create Result
            var _result = new AzureOperationResponse<SubscriptionCreationResult,SubscriptionsCreateSubscriptionUnderBillingProfileHeaders>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<SubscriptionsCreateSubscriptionUnderBillingProfileHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
