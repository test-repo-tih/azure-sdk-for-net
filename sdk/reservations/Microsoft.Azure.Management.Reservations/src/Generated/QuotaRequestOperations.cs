...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    /// </summary>
    internal partial class QuotaRequestOperations : IServiceOperations<MicrosoftCapacityClient>, IQuotaRequestOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal QuotaRequestOperations(MicrosoftCapacityClient client)
        {
            if (client == null)
            {
        ...
        /// This will update the quotas to the values specified.
        /// </remarks>
        ...
        /// </param>
        public async Task<AzureOperationResponse<object>> CreateWithHttpMessagesAsync(string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, string ifMatch, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
        ...
        /// </return>
        public async Task<AzureOperationResponse<object>> BeginCreateWithHttpMessagesAsync(string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, string ifMatch, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
