...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    public static partial class AutoQuotaIncreaseOperationsExtensions
    {
            ...
            /// </param>
            public static AutoQuotaIncreaseDetail SetProperties(this IAutoQuotaIncreaseOperations operations, string subscriptionId, AutoQuotaIncreaseSettings autoQuotaIncreaseRequest)
            {
                return operations.SetPropertiesAsync(subscriptionId, autoQuotaIncreaseRequest).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<AutoQuotaIncreaseDetail> SetPropertiesAsync(this IAutoQuotaIncreaseOperations operations, string subscriptionId, AutoQuotaIncreaseSettings autoQuotaIncreaseRequest, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.SetPropertiesWithHttpMessagesAsync(subscriptionId, autoQuotaIncreaseRequest, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
