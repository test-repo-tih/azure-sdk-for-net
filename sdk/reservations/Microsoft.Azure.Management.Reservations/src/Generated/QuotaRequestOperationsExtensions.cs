...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    public static partial class QuotaRequestOperationsExtensions
    {
            ...
            /// update.
            /// </param>
            public static object Create(this IQuotaRequestOperations operations, string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, string ifMatch)
            {
            ...
            /// </param>
            public static async Task<object> CreateAsync(this IQuotaRequestOperations operations, string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, string ifMatch, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// update.
            /// </param>
            public static object BeginCreate(this IQuotaRequestOperations operations, string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, string ifMatch)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> BeginCreateAsync(this IQuotaRequestOperations operations, string subscriptionId, string providerId, string location, CurrentQuotaLimit createQuotaRequest, string ifMatch, CancellationToken cancellationToken = default(CancellationToken))
            {
