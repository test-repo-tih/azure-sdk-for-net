...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    internal partial class QuotaOperations : IServiceOperations<MicrosoftCapacityClient>, IQuotaOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CurrentQuotaLimit,QuotaListStatusHeaders>> ListStatusWithHttpMessagesAsync(string subscriptionId, string providerId, string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<CurrentQuotaLimit,QuotaListStatusHeaders>();
