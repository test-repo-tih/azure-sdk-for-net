...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    internal partial class QuotaOperations : IServiceOperations<MicrosoftCapacityClient>, IQuotaOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CurrentQuotaLimitBase,QuotaListStatusHeaders>> ListStatusWithHttpMessagesAsync(string subscriptionId, string providerId, string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<CurrentQuotaLimitBase,QuotaListStatusHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<QuotaListStatusHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
