...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    public static partial class QuotasOperationsExtensions
    {
            ...
            /// Azure region.
            /// </param>
            public static IPage<CurrentQuotaLimit> ListStatus(this IQuotasOperations operations, string subscriptionId, string providerId, string location)
            {
            ...
            /// </param>
            public static async Task<IPage<CurrentQuotaLimit>> ListStatusAsync(this IQuotasOperations operations, string subscriptionId, string providerId, string location, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IPage<CurrentQuotaLimit> ListStatusNext(this IQuotasOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<CurrentQuotaLimit>> ListStatusNextAsync(this IQuotasOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
