...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    /// </summary>
    internal partial class ReservationOperations : IServiceOperations<MicrosoftCapacityClient>, IReservationOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ReservationOperations(MicrosoftCapacityClient client)
        {
            if (client == null)
            {
