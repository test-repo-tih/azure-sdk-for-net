...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    public partial interface IQuotaRequestOperations
    {
        ...
        /// update the quotas to the values specified. The location header in
        ...
        /// </exception>
        Task<AzureOperationResponse<object>> CreateWithHttpMessagesAsync(string subscriptionId, string providerId, string location, CurrentQuotaLimitBase createQuotaRequest, string ifMatch, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Submits a Quota Request for a resource provider at the specified
        /// location for the specific resource in the parameter.
        /// </summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<object>> BeginCreateWithHttpMessagesAsync(string subscriptionId, string providerId, string location, CurrentQuotaLimitBase createQuotaRequest, string ifMatch, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
