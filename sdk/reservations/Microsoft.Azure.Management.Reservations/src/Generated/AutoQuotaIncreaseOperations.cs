...
namespace Microsoft.Azure.Management.Reservations
{
    ...
    /// </summary>
    internal partial class AutoQuotaIncreaseOperations : IServiceOperations<MicrosoftCapacityClient>, IAutoQuotaIncreaseOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal AutoQuotaIncreaseOperations(MicrosoftCapacityClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<AutoQuotaIncreaseDetail>> GetPropertiesWithHttpMessagesAsync(string subscriptionId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<AutoQuotaIncreaseDetail>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<AutoQuotaIncreaseDetail>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<AutoQuotaIncreaseDetail>> SetPropertiesWithHttpMessagesAsync(string subscriptionId, AutoQuotaIncreaseSettings autoQuotaIncreaseRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (subscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "subscriptionId");
