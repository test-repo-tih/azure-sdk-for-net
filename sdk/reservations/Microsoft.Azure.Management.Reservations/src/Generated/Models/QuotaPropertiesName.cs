...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    /// </summary>
    public partial class QuotaPropertiesName
    {
        /// <summary>
        /// Initializes a new instance of the QuotaPropertiesName class.
        /// </summary>
        public QuotaPropertiesName()
        {
            CustomInit();
        }
        ...
        public QuotaPropertiesName(string value = default(string), string localizedValue = default(string))
        {
            Value = value;
