...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    /// </summary>
    public partial class CurrentQuotaLimitName
    {
        /// <summary>
        /// Initializes a new instance of the CurrentQuotaLimitName class.
        /// </summary>
        public CurrentQuotaLimitName()
        {
            CustomInit();
        }
        ...
        public CurrentQuotaLimitName(string value = default(string), string localizedValue = default(string))
        {
            Value = value;
