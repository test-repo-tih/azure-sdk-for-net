...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class QuotaRequestOneResourceSubmitResponse : IResource
    {
        ...
        /// <param name="name2">Name of the resource provide by the resource
        ...
        public QuotaRequestOneResourceSubmitResponse(string id = default(string), string name = default(string), string type = default(string), string id1 = default(string), string name1 = default(string), string type1 = default(string), object provisioningState = default(object), string message = default(string), System.DateTime? requestSubmitTime = default(System.DateTime?), int? limit = default(int?), int? currentValue = default(int?), string unit = default(string), QuotaPropertiesName name2 = default(QuotaPropertiesName), object resourceType = default(object), string quotaPeriod = default(string), object properties = default(object))
        {
            Id = id;
            Name = name;
            Type = type;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.properties.message")]
        ...
        /// standard.
        /// </summary>
        [JsonProperty(PropertyName = "properties.properties.requestSubmitTime")]
        ...
        public QuotaPropertiesName Name2 { get; set; }
        ...
        /// <summary>
        /// Gets or sets the quota period over which the usage values are
        /// summarized, such as - P1D (Per one day), PT1M (Per one minute),
