...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    /// </summary>
    public partial class CurrentQuotaLimitBaseName
    {
        /// <summary>
        /// Initializes a new instance of the CurrentQuotaLimitBaseName class.
        /// </summary>
        public CurrentQuotaLimitBaseName()
        {
            CustomInit();
        }
        ...
        public CurrentQuotaLimitBaseName(string value = default(string), string localizedValue = default(string))
        {
            Value = value;
