...
namespace Microsoft.Azure.Management.Reservations.Models
{
    ...
    public partial class Catalog
    {
        ...
        /// resource</param>
        public Catalog(string resourceType = default(string), string name = default(string), IList<CatalogBillingPlansItem> billingPlans = default(IList<CatalogBillingPlansItem>), IList<string> terms = default(IList<string>), IList<string> locations = default(IList<string>), IList<SkuProperty> skuProperties = default(IList<SkuProperty>), IList<SkuRestriction> restrictions = default(IList<SkuRestriction>))
        {
        ...
        public IList<CatalogBillingPlansItem> BillingPlans { get; set; }
