...
namespace Microsoft.Azure.Management.KeyVault.Models
{
    ...
    public partial class Secret : Resource
    {
        ...
        /// </param>
        public Secret(string location, SecretProperties properties, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
