...
namespace Microsoft.Azure.Management.ManagedServices
{
    ...
    public partial interface IMarketplaceRegistrationDefinitionsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<IPage<RegistrationDefinition>>> ListWithHttpMessagesAsync(string scope, string marketplaceIdentifier, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Gets a list of the marketplace registration definitions for the
        /// marketplace identifier.
        /// </summary>
