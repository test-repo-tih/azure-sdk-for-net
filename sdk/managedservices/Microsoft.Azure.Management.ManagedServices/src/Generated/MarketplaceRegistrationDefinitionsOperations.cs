...
namespace Microsoft.Azure.Management.ManagedServices
{
    ...
    internal partial class MarketplaceRegistrationDefinitionsOperations : IServiceOperations<ManagedServicesClient>, IMarketplaceRegistrationDefinitionsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<RegistrationDefinition>>> ListWithHttpMessagesAsync(string scope, string marketplaceIdentifier, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
            ...
            _url = _url.Replace("{marketplaceIdentifier}", marketplaceIdentifier);
